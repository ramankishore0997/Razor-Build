...
const benefits = [
  ...
  },
  {
    ...
    desc: "Scale from ₹10K to ₹10 Crore/month without hitting artificial caps. Your budget, your pace.",
    ...
    <PageWrapper>
      ...
      <section className="relative min-h-[92vh] flex flex-col items-center justify-center text-center px-4 pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-1/3 right-0 w-[300px] h-[300px] bg-cyan-500/10 rounded-full blur-[100px]" />
        </div>
        ...
        <motion.p
          ...
          className="relative text-lg md:text-xl text-white/55 max-w-2xl mb-10 leading-relaxed"
        >
          Most advertisers run on fragile self-serve accounts — random bans, spending caps, zero support.
          Admiz gives your brand the same infrastructure that global agencies use, so your campaigns never stop.
        </motion.p>
        ...
        >
          {[
            { icon: SiMeta, label: "Meta Ads", color: "text-blue-400" },
            { icon: SiGoogleads, label: "Google Ads", color: "text-yellow-400" },
          ].map(({ icon: Icon, label, color }) => (
            <div key={label} className="flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm">
        ...
        >
          <a
            ...
            className="group relative inline-flex items-center gap-3 px-8 py-4 rounded-full bg-[#229ED9] text-white font-black text-sm uppercase tracking-widest overflow-hidden shadow-[0_0_40px_rgba(34,158,217,0.5)] hover:shadow-[0_0_60px_rgba(34,158,217,0.7)] transition-shadow"
          >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((s, i) => (
              ...
              >
                ...
                <div className="text-sm text-white/40 font-medium uppercase tracking-widest">{s.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 md:py-32 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <p className="text-xs font-black tracking-[0.3em] text-primary uppercase mb-4">Why Admiz</p>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter text-white mb-6">
              What You Get When<br />
              <span className="text-white/40">You Run Ads With Us</span>
            </h2>
            ...
            {benefits.map((b, i) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ y: -6 }}
                  className="group relative p-7 rounded-2xl border border-white/8 bg-white/[0.03] backdrop-blur-sm overflow-hidden cursor-default"
        ...
        <div className="container mx-auto max-w-5xl text-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-black tracking-tighter text-white">
              ...
              <span className="text-white/40">of Businesses</span>
            </h2>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {businesses.map((biz, i) => (
              <motion.div
                ...
                whileInView="show"
                viewport={{ once: true }}
                className="flex items-center gap-2 px-5 py-2.5 rounded-full border border-white/10 bg-white/[0.04] text-white/70 text-sm font-semibold hover:border-primary/40 hover:text-white hover:bg-primary/10 transition-all duration-300 cursor-default"
              >
          ...
          <motion.p
            ...
            className="mt-10 text-white/35 text-sm"
          >
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-black tracking-tighter text-white">
              ...
              <span className="text-white/40">Easier Than You Think</span>
            </h2>
          </motion.div>

          <div className="relative flex flex-col gap-0">
            {/* vertical line */}
            <div className="absolute left-8 md:left-1/2 top-8 bottom-8 w-px bg-gradient-to-b from-primary/60 via-purple-500/40 to-transparent hidden sm:block" style={{ transform: "translateX(-50%)" }} />
              ...
              return (
                ...
                >
                  ...
                  <div className={`flex-1 ${isRight ? "md:pl-12" : "md:pr-12"}`}>
                    <div className="group p-7 rounded-2xl border border-white/8 bg-white/[0.03] hover:border-primary/30 hover:bg-primary/5 transition-all duration-500">
                  ...
                  <div className="hidden md:flex w-0 flex-col items-center justify-center relative z-10">
                    <div className="w-5 h-5 rounded-full bg-primary border-4 border-background shadow-[0_0_20px_rgba(0,102,255,0.8)]" />
                  </div>
      ...
      <section className="py-24 md:py-32 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          >
            {/* glow border */}
            <div className="absolute -inset-0.5 bg-gradient-to-r from-primary via-purple-500 to-cyan-400 rounded-3xl blur opacity-40" />
            <div className="relative rounded-3xl border border-white/10 bg-black/70 backdrop-blur-xl px-8 py-16 md:px-16 md:py-20 text-center">
              {/* ambient */}
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-0 left-1/4 w-[400px] h-[300px] bg-primary/15 rounded-full blur-[100px]" />
                <div className="absolute bottom-0 right-1/4 w-[400px] h-[300px] bg-purple-500/10 rounded-full blur-[100px]" />
              </div>

              <div className="relative">
                <div className="flex items-center justify-center gap-2 mb-6">
                  <SiMeta className="w-5 h-5 text-blue-400" />
                  <span className="text-white/30 text-xs">+</span>
                  <SiGoogleads className="w-5 h-5 text-yellow-400" />
                </div>
                ...
                <a
                  ...
                  className="group relative inline-flex items-center gap-3 px-10 py-5 rounded-full bg-[#229ED9] text-white font-black text-base uppercase tracking-widest overflow-hidden shadow-[0_0_60px_rgba(34,158,217,0.6)] hover:shadow-[0_0_80px_rgba(34,158,217,0.8)] transition-all duration-300"
                >
                ...
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-6 text-sm text-white/35">
