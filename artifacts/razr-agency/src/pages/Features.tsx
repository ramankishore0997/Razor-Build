...
export default function Features() {
  ...
  return (
    <PageWrapper>
      ...
      {/* ─────────────── HERO ─────────────── */}
      <section className="relative min-h-[72vh] pt-28 pb-12 flex items-center overflow-hidden">
        <LightBeams />
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <h1 className="text-5xl md:text-7xl lg:text-[6.5rem] font-black uppercase tracking-tighter leading-[0.9] mb-8">
              Built for <br />
            ...
            <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-3 max-w-3xl">
              {[
                ...
                <motion.div
                  ...
                  className="rounded-2xl border border-white/10 bg-black/40 backdrop-blur-xl px-4 py-3"
                >
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="mb-12 flex items-end justify-between gap-6 flex-wrap">
            <div>
              ...
              <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter">Premium <span className="font-light italic text-white/50">capabilities.</span></h2>
            </div>
            <p className="text-white/50 max-w-md">Each capability isn't a feature — it's infrastructure built and tested at scale.</p>
          </div>
            ...
            {BENTO.map((b, i) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -4 }}
                  className={`relative group rounded-3xl border border-white/10 bg-black/40 backdrop-blur-xl overflow-hidden ${b.span}`}
                >
                  ...
                  <div className="relative p-7 h-full flex flex-col">
                    <div className="flex items-start justify-between mb-4">
                      <div className="w-12 h-12 rounded-xl border border-primary/30 bg-primary/10 flex items-center justify-center group-hover:scale-110 group-hover:-rotate-6 transition-transform duration-500">
                        <Icon className="w-5 h-5 text-primary" />
                      </div>
                      <div className="text-right">
                        <div className="text-xl font-black text-white tabular-nums">{b.stat.v}</div>
                        <div className="text-[9px] uppercase tracking-wider text-white/40 font-bold">{b.stat.l}</div>
                      </div>
                    </div>
                    <h3 className="text-xl md:text-2xl font-black uppercase tracking-tight mb-2 leading-tight">{b.title}</h3>
        ...
        <div className="sticky top-0 h-screen overflow-hidden flex flex-col justify-center">
          ...
          <motion.div ref={trackRef} style={{ x }} className="flex gap-6 pl-[8vw]">
            {HSCROLL.map((c, i) => {
              const Icon = c.Icon;
              return (
                <div key={i} className="relative group shrink-0 w-[85vw] sm:w-[60vw] md:w-[44vw] lg:w-[34vw]">
      ...
      <section className="py-16 relative">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter">The receipts.</h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {METRICS.map((m, i) => (
              <motion.div
                ...
                className="relative group rounded-3xl border border-white/10 bg-black/40 backdrop-blur-xl p-8 overflow-hidden"
              >
                ...
                <div className="relative">
                  ...
                  <div className="text-xs font-black uppercase tracking-wider text-white/40">{m.label}</div>
                  {/* mini bars */}
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="relative group">
            ...
            <div className="relative rounded-3xl border border-white/15 bg-black/80 backdrop-blur-2xl p-12 md:p-16 text-center overflow-hidden">
              ...
              <Rocket className="w-12 h-12 text-primary mx-auto mb-6" strokeWidth={1.5} />
              ...
              <p className="text-lg text-white/60 mb-10 max-w-2xl mx-auto">Get activated in under an hour. Lifetime support included. No setup fees, no hidden costs.</p>
