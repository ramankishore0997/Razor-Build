...
export default function About() {
  return (
    <PageWrapper>
      ...
      <div className="absolute top-[60%] right-0 w-[500px] h-[500px] bg-purple-500/10 rounded-full blur-[140px] pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div className="lg:col-span-5">
              <div className="relative group h-full">
                <div className="absolute -inset-0.5 bg-gradient-to-br from-primary/40 via-purple-500/30 to-cyan-500/30 rounded-3xl blur opacity-50 group-hover:opacity-80 transition-opacity duration-500" />
                <div className="relative rounded-3xl border border-white/10 bg-black/60 backdrop-blur-xl p-8 md:p-10 overflow-hidden h-full">
                  <motion.div
                    animate={{ x: ["-100%", "200%"] }}
                  ...
                  <div className="flex items-center gap-3 pt-6 border-t border-white/10">
                    <div className="w-2 h-2 rounded-full bg-primary shadow-[0_0_10px_rgba(0,102,255,1)]" />
                    <span className="text-xs uppercase tracking-wider text-white/50">Built for operators who scale</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {STATS.map((s, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="relative group rounded-3xl border border-white/10 bg-black/40 backdrop-blur-xl p-6 md:p-8 overflow-hidden"
                >
                  ...
                  <div className="text-xs font-black uppercase tracking-wider text-white/50 mt-2">{s.label}</div>
                </motion.div>
              );
            })}
          </div>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter">
              From idea <span className="font-light italic text-white/50">to global infrastructure.</span>
            </h2>
          </div>

          <div className="relative">
            {/* center line */}
            <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-px md:-translate-x-1/2 bg-gradient-to-b from-primary via-purple-500 to-cyan-400 opacity-30" />
                  ...
                  >
                    ...
                    <div className="absolute left-6 md:left-1/2 top-6 md:-translate-x-1/2 z-10">
                      <div className="relative">
                        ...
                        <div className="relative w-4 h-4 rounded-full bg-primary border-2 border-background shadow-[0_0_15px_rgba(0,102,255,1)]" />
                      </div>
                    </div>

                    <div className={`${left ? "md:text-right md:pr-10" : "md:pl-10"} ${left ? "" : "md:col-start-2"}`}>
                      <div className="text-5xl md:text-6xl font-black text-white/10 leading-none mb-1">{t.year}</div>
                    </div>
                    <div className={`${left ? "" : "md:col-start-1 md:row-start-1 md:pr-10 md:text-right"}`}>
                      <div className="relative group rounded-2xl border border-white/10 bg-black/40 backdrop-blur-xl p-6 hover:border-white/20 transition-colors">
