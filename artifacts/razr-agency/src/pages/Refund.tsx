      ...
      <section className="pt-28 pb-16 relative">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            <div className="rounded-3xl border border-emerald-500/20 bg-emerald-500/[0.04] p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-black uppercase tracking-tight">Eligible for Refund</h3>
              </div>
            ...
            <div className="rounded-3xl border border-red-500/20 bg-red-500/[0.04] p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-black uppercase tracking-tight">Not Eligible</h3>
              </div>
              <ul className="space-y-3">
          ...
          <div className="space-y-10">
            {SECTIONS.map((s) => (
              <div key={s.title} className="border-l-2 border-white/10 pl-6 md:pl-8 hover:border-primary transition-colors">
