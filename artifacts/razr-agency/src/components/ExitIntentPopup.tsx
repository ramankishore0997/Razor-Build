    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            <div className="absolute -inset-1 bg-gradient-to-br from-primary via-purple-500 to-cyan-400 rounded-3xl blur-2xl opacity-50 pointer-events-none" />

            <div className="relative rounded-3xl border border-white/10 bg-black/95 backdrop-blur-2xl p-7 md:p-10 overflow-hidden">
              ...
              <button
                ...
                className="absolute top-4 right-4 w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/10 transition-colors z-10"
              >
                <X className="w-4 h-4" />
              </button>

              <div className="relative">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-amber-500/40 bg-amber-500/10 backdrop-blur mb-5">
                ...
                <h2 id="exit-popup-title" className="text-3xl md:text-4xl font-black uppercase tracking-tighter leading-[0.95] mb-4 text-white">
                  Don't leave <span className="font-light italic text-white/60">empty-handed.</span>
                </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    onClick={close}
                    className="px-6 py-4 rounded-2xl border border-white/10 text-white/60 text-xs font-bold uppercase tracking-widest hover:bg-white/5 hover:text-white transition-colors"
                  >
                    No thanks
                  </button>
                </div>

                <div className="mt-5 flex items-center justify-center gap-2 text-[10px] uppercase tracking-wider text-white/30 font-bold">
                  <Clock className="w-3 h-3" />
                  Offer expires Sunday 11:59 PM IST
                </div>
              </div>
            </div>
          </motion.div>
