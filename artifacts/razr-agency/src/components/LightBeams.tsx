  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <motion.div
        ...
        className="absolute top-0 right-1/3 w-px h-full origin-top bg-gradient-to-b from-purple-500 via-purple-500/20 to-transparent blur-[1px]"
      />
      ...
      <motion.div
        ...
        className="absolute top-2/3 left-0 w-[35%] h-px bg-gradient-to-r from-transparent via-cyan-400/40 to-transparent"
      />
      {/* radial pulse */}
      <motion.div
      ...
      <motion.div
        ...
        className="absolute top-1/3 right-0 w-[400px] h-[400px] rounded-full bg-purple-500/10 blur-[100px]"
      />
    </div>
  );
}
