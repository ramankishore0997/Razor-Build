...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-[60] flex items-center justify-center gap-3 w-14 h-14 md:w-auto md:h-auto md:px-5 md:py-4 rounded-full bg-[#229ED9] text-white font-bold uppercase tracking-widest text-sm shadow-[0_10px_40px_rgba(34,158,217,0.5)] hover:scale-105 hover:shadow-[0_15px_50px_rgba(34,158,217,0.7)] transition-all duration-300 group pb-[env(safe-area-inset-bottom)]"
