      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="relative">
            {/* glow */}
            <div className="absolute -inset-1 bg-primary/30 blur-xl rounded-2xl opacity-50" />

            <div className="relative flex items-center gap-3 px-3.5 py-3 rounded-2xl border border-white/15 bg-black/80 backdrop-blur-xl shadow-[0_20px_50px_-15px_rgba(0,0,0,0.8),inset_0_1px_0_rgba(255,255,255,0.08)]">
              <div className={`shrink-0 w-9 h-9 rounded-xl bg-white/[0.04] border border-white/10 flex items-center justify-center ${event.color}`}>
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="shrink-0 w-1.5 h-1.5 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.9)] animate-pulse" />
                </div>
                <div className="text-[10.5px] uppercase tracking-wider text-white/45 mt-0.5 truncate">{event.meta}</div>
              </div>
            </div>
          </div>
        </motion.div>
