...
const TEMPLATES: Record<WaIntent, (e: IntentExtras) => string> = {
  ...
  "setup-access": () =>
    "Hi RAZR — I'm interested in the STARTUP plan (₹1,999). Please share details, account access & next steps.",
  "full-access": () =>
    "Hi RAZR — I'm interested in the FULL SETUP plan (₹2,999). Please share details, onboarding timeline & lifetime guarantee terms.",
  "book-call": (e) =>
